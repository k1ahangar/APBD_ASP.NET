...
public static class DataStore
{
    ...
    public static int NextRoomId =>
        Rooms.Any() ? Rooms.Max(r => r.Id) + 1 : 1;

    public static int NextReservationId =>
        Reservations.Any() ? Reservations.Max(r => r.Id) + 1 : 1;
}